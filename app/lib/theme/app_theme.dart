...
class AppColors {
  // Modern sakura-inspired palette with natural balance
  static const Color primary = Color(0xFFE8A5C0); // Softer, more natural pink
  ...
  static const Color borderGray = Color(0xFFF7FAFC); // Very subtle neutral border
  static const Color backgroundGray = Color(0xFFFBFDFE); // Clean, modern background
